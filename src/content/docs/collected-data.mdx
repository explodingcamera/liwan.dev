...
- **URLs**: The URL of the page that was visited
- **UTM Parameters**: If present in the URL, Liwan collects UTM parameters for campaign tracking (utm_source, utm_medium, utm_campaign, utm_content, utm_term).
...
- **Screen Orientation / Width**: The screen orientation (portrait/landscape) and approximate screen width (e.g., XS, SM, MD, LG, XL, 2XL).
...
- **Query Parameters and URL Fragments**: Liwan strips these from tracked page URLs (except for utm parameters if present).

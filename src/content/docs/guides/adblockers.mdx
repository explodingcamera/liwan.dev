...
While it is debatable whether you should try to circumvent this, there are a few things you can do to make it less likely that your users' adblockers block Liwan's tracking script:

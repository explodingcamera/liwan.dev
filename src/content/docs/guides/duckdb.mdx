...
DuckDB, the OLAP database embedded in Liwan, is designed to be fast and efficient out of the box. However, there are a few settings that can be tweaked to improve performance
...
fast disks and avoid network storage.

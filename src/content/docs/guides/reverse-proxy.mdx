...
To avoid spoofed values, only trust headers set by your own edge proxy/load balancer.
Your edge should strip incoming client-provided forwarding headers and set canonical values itself.
